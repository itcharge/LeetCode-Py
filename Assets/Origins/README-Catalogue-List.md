...
- 多模式串匹配
  - 字典树
    - [字典树知识](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/06.String/03.String-Multi-Pattern-Matching/01.Trie/01.Trie.md)
    - [字典树题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/06.String/03.String-Multi-Pattern-Matching/01.Trie/02.Trie-List.md)
  - AC 自动机
    ...
    - [AC 自动机题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/06.String/03.String-Multi-Pattern-Matching/02.AC-Automaton/02.AC-Automaton-List.md)
  - 后缀数组
    - [后缀数组知识](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/06.String/03.String-Multi-Pattern-Matching/03.Suffix-Array/01.Suffix-Array.md)
    - [后缀数组题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/06.String/03.String-Multi-Pattern-Matching/03.Suffix-Array/02.Suffix-Array-List.md)

## 07. 树

- 二叉树
  - [树与二叉树基础知识](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/07.Tree/01.Binary-Tree/01.Binary-Tree-Basic/01.Binary-Tree-Basic.md)
  - 二叉树的遍历
    ...
    - [二叉树的遍历题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/07.Tree/01.Binary-Tree/02.Binary-Tree-Traverse/02.Binary-Tree-Traverse-List.md)
  - 二叉树的还原
    ...
    - [二叉树的还原题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/07.Tree/01.Binary-Tree/03.Binary-Tree-Reduction/02.Binary-Tree-Reduction-List.md)
- 二叉搜索树
...
- 树状数组
  ...
  - [树状数组题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/07.Tree/04.Binary-Indexed-Tree/02.Binary-Indexed-Tree-List.md)
- 并查集
...
- 图的遍历
  - 图的深度优先搜索
    ...
    - [图的深度优先搜索题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/02.Graph-Traversal/01.Graph-DFS/02.Graph-DFS-List.md)
  - 图的广度优先搜索
    ...
    - [图的广度优先搜索题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/02.Graph-Traversal/02.Graph-BFS/02.Graph-BFS-List.md)
  - 图的拓扑排序
    ...
    - [图的拓扑排序题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/02.Graph-Traversal/03.Graph-Topological-Sorting/02.Graph-Topological-Sorting-List.md)
- 图的生成树
  ...
  - [图的生成树题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/03.Gaph-Spanning-Tree/03.Gaph-Spanning-Tree-List.md)
- 最短路径
  - 单源最短路径
    ...
    - [单源最短路径题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/04.Graph-Shortest-Path/01.Graph-Single-Source-Shortest-Path/04.Graph-Single-Source-Shortest-Path-List.md)
  - 多源最短路径
    ...
    - [多源最短路径题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/04.Graph-Shortest-Path/02.Graph-Multi-Source-Shortest-Path/02.Graph-Multi-Source-Shortest-Path-List.md)
  - 次短路径
    ...
    - [次短路径题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/04.Graph-Shortest-Path/03.Graph-The-Second-Shortest-Path/02.Graph-The-Second-Shortest-Path-List.md)
  - 差分约束系统
    ...
    - [差分约束系统题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/04.Graph-Shortest-Path/04.Graph-System-Of-Difference-Constraints/02.Graph-System-Of-Difference-Constraints-List.md)
- 二分图
  - 二分图基础知识
    ...
    - [二分图基础题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/05.Graph-Bipartite/01.Graph-Bipartite-Basic/02.Graph-Bipartite-Basic-List.md)
  - 二分图最大匹配
    ...
    - [二分图最大匹配题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/08.Graph/05.Graph-Bipartite/02.Graph-Bipartite-Matching/03.Graph-Bipartite-Matching-List.md)
...
- 回溯算法
  ...
  - [回溯算法题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/09.Algorithm-Base/05.Backtracking-Algorithm/02.Backtracking-Algorithm-List.md)
- 贪心算法
  ...
  - [贪心算法题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/09.Algorithm-Base/03.Greedy-Algorithm/02.Greedy-Algorithm-List.md)
- 分治算法
  ...
  - [分治算法题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/09.Algorithm-Base/04.Divide-And-Conquer-Algorithm/02.Divide-And-Conquer-Algorithm-List.md)
- 位运算
...
- 背包问题
  - [背包问题知识](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/10.Dynamic-Programming/03.Knapsack-Problem/01.Knapsack-Problem.md)
  - [背包问题题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/10.Dynamic-Programming/03.Knapsack-Problem/02.Knapsack-Problem-List.md)
- 线性 DP
  - [线性 DP 知识](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/10.Dynamic-Programming/04.Linear-DP/01.Linear-DP.md)
  - [线性 DP 题目](https://github.com/itcharge/LeetCode-Py/blob/main/Contents/10.Dynamic-Programming/04.Linear-DP/02.Linear-DP-List.md)
- 区间 DP
