...
![$\Theta$、$O$、$\Omega$ 符号的图例](https://qcdn.itcharge.cn/images/202109092356694.png)
...
- **乘法原则**：循环嵌套代码的复杂度等于嵌套内外基本语句的时间复杂度成绩。
...
- 【文章】[
图解算法数据结构 - 算法复杂度 - LeetBook - 力扣](https://leetcode-cn.com/leetbook/read/illustration-of-algorithm/r84gmi/)