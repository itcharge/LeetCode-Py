...
![image-20210617202117148](http://qncdn.bujige.net/images/20210705164838.png)
...
![image-20210617202156824](http://qncdn.bujige.net/images/20210705164847.png)
...
![image-20210705150937392](http://qncdn.bujige.net/images/20210705164854.png)
...
![image-20210617202521016](http://qncdn.bujige.net/images/20210705164900.png)
...
![image-20210705100532728](http://qncdn.bujige.net/images/20210705164906.png)
...
![image-20210705151058420](http://qncdn.bujige.net/images/20210705164911.png)

在顺序存储结构中，逻辑上相邻的数据元素在物理地址上也必然相邻 。

这种结构的优点是：简单、易理解，且实际张勇最少的存储空间。缺点是：需要占用一片地址连续的存储单元；并且存储分配要事先进行；另外对于一些操作的时间效率较低（移动、删除元素等操作）。

#### 2. 链式存储结构

> 链式存储结构（Linked  Storage Structure）：将数据元素存放在任意的存储单元里，存储单元可以连续，也可以不连续。

![image-20210705153007598](http://qncdn.bujige.net/images/20210705164916.png)
